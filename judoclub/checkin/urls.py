...
urlpatterns = patterns('checkin.views',
    ...
    url(r'^delete_user_award/(?P<award_id>[\d]+)/$', 'delete_user_award', name='delete_user_award'),
    ...
    url(r'^create_student_course/(?P<user_id>[\d]+)/$', 'create_student_course', name='create_student_course'),
